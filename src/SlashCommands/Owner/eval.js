...
module.exports = {
    ...
    run: async (client, interaction, args) => {
      ...
      if(!client.config.developers.includes(interaction.user.id)) return msg.edit(`Fatal Auth Error has been occured⚠\nIf You are seeing this message Contact Udayana#5236 Right Away\n\n\nError at line 1\n\nCode: ${codeToEval}`)
